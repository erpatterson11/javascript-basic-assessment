...
var indexFlash = heroes.indexOf('flash');
var secondHero = heroes.splice(indexFlash,1);
// leave batman in the array but put a copy of him on a variable called thirdHero

var indexBatman = heroes.indexOf('batman');
var thirdHero = heroes.slice(indexBatman,indexBatman+1).join('');
...
// #14 Create a function called coderTest that takes in an object that is a person. It looks to see if the person’s name is Jeremy and then changes the person object to have a property called lovesCode
